package dev.axelspringerkugawana.scim2.client;
...
import dev.axelspringerkugawana.scim2.schema.data.misc.*;
...
import dev.axelspringerkugawana.scim2.schema.data.sp.SpConfig;
import dev.axelspringerkugawana.scim2.schema.enums.HttpMethod;
import dev.axelspringerkugawana.scim2.schema.enums.ScimOperation;
import dev.axelspringerkugawana.scim2.schema.ex.ScimException;
import dev.axelspringerkugawana.scim2.schema.util.Scim2Protocol;
import dev.axelspringerkugawana.scim2.schema.util.UrlUtil;
import lombok.Data;
import okhttp3.*;
