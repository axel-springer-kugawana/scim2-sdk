package dev.axelspringerkugawana.scim2.schema.builder;

import com.google.common.collect.ImmutableSet;
import dev.axelspringerkugawana.scim2.schema.ScimConstant;
import dev.axelspringerkugawana.scim2.schema.data.group.GroupDefinition;
...
import dev.axelspringerkugawana.scim2.schema.data.resource.ResourceTypeDefinition;
import dev.axelspringerkugawana.scim2.schema.data.schema.Schema;
import dev.axelspringerkugawana.scim2.schema.data.schema.SchemaDefinition;
import dev.axelspringerkugawana.scim2.schema.data.sp.SpConfigDefinition;
import dev.axelspringerkugawana.scim2.schema.data.user.EnterpriseUserDefinition;
import dev.axelspringerkugawana.scim2.schema.data.user.UserDefinition;

import java.util.Date;

import static dev.axelspringerkugawana.scim2.schema.ScimConstant.*;
